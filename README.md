...
| 963500                        | 2018-06-03 | v7                | v0.12.0.0                 | v0.12.7.0-aeon                    | Rebase to Monero's latest codebase with RingCT disabled, CryptoNight-Lite variant 1, limited use of ringsize 1, ban ringsize 2   |
...
```
	...
	cd aeon
	git checkout tags/v0.12.7.0-aeon
```
* Build:
```
        make release
...
* If you would like a specific [version/tag](https://github.com/aeonix/aeon/tags), do a git checkout for that version. eg. 'v0.12.7.0-aeon'. If you dont care about the version and just want binaries from master, skip this step:
